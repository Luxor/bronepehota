...
export default function UnitCard({ unit, updateUnit }: UnitCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Combat Modal */}
      {activeCombatSoldier !== null && (
        <div className="absolute inset-0 z-50 bg-slate-900/95 p-4 flex flex-col animate-in zoom-in duration-200">
          ...
          {(combatType === 'shot' || combatType === 'grenade') ? (
            ...
            !shotResult && !isRolling ? (
                      ...
                      {[0, 1, 3].map(v => (
                        <button
                          ...
                          className={cn(
                            ...
                            shotCover === v ? "bg-blue-600 border-blue-400 text-white" : "bg-slate-900 border-slate-700 text-slate-500"
                          )}
                        >
                          {v === 0 ? 'НЕТ' : `+${v}`}
                        </button>
              ...
              <div className="flex-1 flex flex-col justify-center gap-4 text-center animate-in fade-in slide-in-from-bottom-2">
                ...
                <div className="flex flex-col gap-4">
                   <div className={cn(
                    ...
                    <div className="flex justify-center items-center gap-3">
                      <div className={cn(
                        "w-12 h-12 bg-slate-900 rounded-lg border-2 flex items-center justify-center text-xl font-black shadow-lg transition-transform",
                        isRolling && !shotResult ? "animate-bounce scale-110 border-orange-500" : "border-slate-700"
                      )}>
                        {displayRolls.hit || '?'}
                      </div>
                      {shotResult && (
                  ...
                  {(displayRolls.power || (shotResult && (shotResult.hit.success || shotResult.hit.isGrenade))) && (
                    <div className={cn(
                      "p-4 rounded-xl border-2 transition-all",
                      shotResult ? (shotResult.damage.damage > 0 ? "bg-orange-900/20 border-orange-500/50" : "bg-slate-800 border-slate-700") : "bg-slate-800 border-orange-500/30"
                    )}>
                      ...
                      <div className="flex justify-center items-center gap-2 flex-wrap">
                        {displayRolls.power?.map((r, i) => (
                          <div key={i} className={cn(
                            "w-10 h-10 bg-slate-900 rounded-lg border-2 flex items-center justify-center text-lg font-black shadow-lg",
                            isRolling && shotResult ? "animate-pulse border-orange-500" : "border-slate-700",
            ...
            /* Melee Mode */
            !meleeResult && !isRolling ? (
              <div className="space-y-4">
                <div className="bg-slate-800 p-3 rounded-lg border border-slate-700">
                  <div className="text-[10px] opacity-50 uppercase font-bold mb-2">Параметры боя</div>
                  <div className="space-y-1">
              ...
              <div className="flex-1 flex flex-col justify-center gap-4 text-center animate-in fade-in slide-in-from-bottom-2">
                <div className="grid grid-cols-2 gap-4">
                  <div className={cn(
                    ...
                    isRolling ? "border-blue-500/50 animate-pulse" : "border-slate-700"
                  )}>
                  ...
                  <div className={cn(
                    "bg-slate-800 p-4 rounded-xl border-2 transition-all",
                    isRolling ? "border-red-500/50 animate-pulse" : "border-slate-700"
                  )}>
                    ...
                    <div className="flex-1 flex flex-col justify-between min-w-0">
                        ...
                        <div className="flex gap-1 md:gap-1.5 flex-wrap">
                          <button
                            ...
                            className={cn(
                              ...
                              actions.moved ? "bg-blue-600 text-white shadow-lg shadow-blue-900/50" : "bg-slate-800 text-slate-500 border border-slate-700"
                            )}
                            title="Движение"
                          >
                          ...
                          <button
                            disabled={isDone || isDead}
                            onClick={() => {
                              setActiveCombatSoldier(idx);
                              setCombatType('shot');
                              setShotResult(null);
                            }}
                            className={cn(
                              "p-1.5 md:p-2 rounded transition-colors min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 flex items-center justify-center",
                              actions.shot ? "bg-orange-600 text-white shadow-lg shadow-orange-900/50" : "bg-slate-800 text-slate-500 border border-slate-700"
                            )}
                            title="Выстрел"
                          >
                          ...
                          <button
                            ...
                            className={cn(
                              "p-1.5 md:p-2 rounded transition-colors min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 flex items-center justify-center",
                              actions.melee ? "bg-red-600 text-white shadow-lg shadow-red-900/50" : "bg-slate-800 text-slate-500 border border-slate-700"
                            )}
                            title="Ближний бой"
                          >
                          ...
                          <button
                            disabled={isDone || isDead || unit.grenadesUsed}
                            onClick={() => {
                              setActiveCombatSoldier(idx);
                            ...
                            className={cn(
                              "p-1.5 md:p-2 rounded transition-colors min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 flex items-center justify-center",
                              unit.grenadesUsed ? "bg-slate-800 text-slate-700" : "bg-green-700 text-white"
                            )}
                            title="Бросить гранату"
                          >
                      ...
                      <div className="flex items-center gap-2 md:gap-4 mt-1.5 md:mt-2 flex-wrap">
                        <div className="flex gap-2 md:gap-4">
                          ...
                          <span className="flex items-center gap-0.5 md:gap-1 text-xs md:text-sm font-black text-red-500 bg-slate-900/50 px-1.5 md:px-2 py-0.5 rounded border border-red-900/30" title="Ближний бой">
                            <Sword className="w-3 h-3 md:w-4 md:h-4" /> {s.melee}
                          </span>
